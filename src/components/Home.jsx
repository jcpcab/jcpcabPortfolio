  ...
  return (
    ...
    {/*container*/}
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full '>
            <h1 className='text-4xl sm:text-7xl font-semibold text-[#FFFFFF] max-w-[500px]' >Building lovely web experiences.</h1>
            <h2 className='hidden text-4xl sm:text-7xl font-bold text-[#9191A4]'>Welcome to my space!</h2>
